...
const MainLabel = () => {
    ...
    return (
        <>
            <h1 className="text-center text-6xl font-bold">Find Excellence</h1>
            <div className="grid grid-col grid-cols-1 md:grid-cols-2 px-8 md:px-10 lg:grid-cols-4 lg:px-30 justify-center items-center gap-6">
